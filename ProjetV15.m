        ...
        for m = 1:Total_T%Number of Transmitter
            for n = 1:Total_R %Number of Receiver
                ...
                if takeWavelength == 0
                    ...
                    radT = interp1(rad2deg(theta), radiation_pattern_directive, Tangles(m,o), 'nearest', 'extrap');
                ...
                elseif radiation == 3
                    S(l,m,n,o) = term*sigma*exp(phase*r)*abs(radT)*sqrt(abs(radR))/(4*pi*r1*r2);
                end
            end
        end
    end

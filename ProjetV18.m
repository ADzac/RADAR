...
radius = 0.25; % Sphere radius in meters
            ...
            for n = 1:Total_R %Number of Receiver
                ...
                if takeWavelength == 0
                    ...
                    if (bande_f(l) == fc && fctrue == true)
                        ...
                        subplot(1, 2, 2);
                        plot(rad2deg(theta_SER), 10*log10(E));
                    ...
                    radR = interp1(rad2deg(theta), radiation_pattern_directive, Rangles(n,o),  'nearest', 'extrap');
